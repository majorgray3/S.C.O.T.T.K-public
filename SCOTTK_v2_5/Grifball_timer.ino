...
Serial.println("Purple light ");
        ...
        digitalWrite(blueLEDRelay, HIGH);
     attachInterrupt(digitalPinToInterrupt(interruptRed), newRoundInterrupt, RISING);
     attachInterrupt(digitalPinToInterrupt(interruptBlue), newRoundInterrupt, RISING);  
timerStart = true;
loopDelay = 0;
currentTime = millis();
nextRoundStarting = gameTime - firstRoundReGroupSetpoint;
